...
import javax.swing.JOptionPane;
	...
	public class Exercicio06{
		...
		"Para realizar seu pedido, digite o cÃ³digo do produto desejado"+
		"\n|------------------------------------------------------------------------------|"+
		"\n| CÃ“DIGO |    TIPO    |                    NOME                     |   VALOR  |"+
		"\n|------------------------------------------------------------------------------|"+
		...
		"\n|------------------------------------------------------------------------------|"+
		"\n|   8    | SanduÃ­ches | FilÃ©-Mignon com fritas e cheddar            | R$ 21,16 |"+
		"\n|------------------------------------------------------------------------------|"+
		"\n|   9    | SanduÃ­ches | HambÃºrguer com queijos, champignon e rÃºcula | R$ 12,70 |"+
		"\n|------------------------------------------------------------------------------|"+
		"\n|   10   | SanduÃ­ches | Provolone com salame                        | R$ 19,70 |"+
		"\n|------------------------------------------------------------------------------|"+
		"\n|   11   | SanduÃ­ches | Vegetariano com berinjela                   | R$ 28,22 |"+
		"\n|------------------------------------------------------------------------------|"+
		...
		"A quantidade de produtos escolhidos Ã©: "+quantidadeProdutos+
		"\nTotalizando R$ "
		);
=======
import javax.swing.JOptionPane;
...
>>>>>>> a3b9e1d2e6984a8b0551fdcef507da1f024abd56
